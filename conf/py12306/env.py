...
QUERY_JOBS = [
    {
        ...
        # 筛选时间
        'period': { 'from': '06:00', 'to': '15:00'},
        # 车站 支持多个车站同时查询  :Dict or :List
        ...
        'seats': ['硬卧'],
        # 筛选车次 可以为空，为空则所有车次都可以提交 如 [] 注意大小写需要保持一致 
        'train_numbers': ["K817", "k117", "k183"], 
        # 筛选车次，排除车次  train_numbers 和 except_train_numbers 不可同时存在
...
NOTIFICATION_API_APP_CODE = '6a6099f729c94b5ba54241ebf1061325'
NOTIFICATION_VOICE_CODE_PHONE = '15811019845'  # 接受通知的手机号

# 钉钉通知
DINGTALK_ENABLED = 1
DINGTALK_WEBHOOK = 'https://oapi.dingtalk.com/robot/send?access_token=bf833399540377db15e19850b3c1535cd32f1ebd389d4782daedd70c5855f1a4'
...
# 登录信息
WEB_USER = {'username': 'zhuyawei', 'password': 'zhuyawei'}
WEB_PORT = 8008  # 监听端口
